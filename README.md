...
Mango db commands
    ...
    First run the mongo db in docker : docker compose up -d
    once run the projects create registration post eg: http://localhost:8080/registrations {"productId": 801, "attendeeName": "Test RK Manngo db"}
    run this mongo db commands in terminal : docker exec -it tickets-mongo-1 mongosh
    to see the created collection use this command in terminal: show collections
    to view the data use this command : db.registrations.find()
